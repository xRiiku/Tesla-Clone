...
function Header() {
    return (
    <main className="py-3 px-10 flex items-center fixed top-0 w-full justify-between">
        <div className="flex flex-grow basis-0">
            <Logo />
        </div>

        <nav>
            <ul className="flex text-sm [&>li>a]:text-gray-900 [&>li>a]:inline-block [&>li>a]:px-4 [&>li>a]:py-2">
